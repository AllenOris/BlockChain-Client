    ...
    <div class="fillcontain">
        <div style="margin: 20px;">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item>资金方</el-breadcrumb-item>
                <el-breadcrumb-item>我注资的平台</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <el-button @click="handleCheck(scope.row)" type="text" size="small">查看平台用户</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </el-card>
